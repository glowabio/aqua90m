...
class SnappedPointsGetterPlural(BaseProcessor):
    ...
    def _execute(self, data, requested_outputs, conn):
        ...
        if not geometry_only:
            ...
            if self.return_hyperlink('snapped_points', requested_outputs):
                LOGGER.debug('Will return file:')
                return 'application/json', self.store_to_json_file('snapped_points', feature_coll)
            else:
                LOGGER.debug('Will return feature collection: %s' % feature_coll)
